...
router.post('/generate', authenticateToken, async (req, res) => {
  ...
  try {
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        // Käytetään tällä hetkellä toimivia malleja
        model: "llama-3.3-70b-versatile",     // Paras laatu
        // model: "llama-3.1-8b-instant",     // Nopeampi vaihtoehto
        messages: [
          { 
            role: "system", 
...
Pidä SPR:n brändi: luotettava, auttavainen, yhteisöllinen, punainen väri.

Palauta VAIN JSON-muodossa ilman ylimääräistä tekstiä:
{
  "otsikko": "...",
  "sisalto": "...",
  "kehotus": "..." 
    ...
    if (!response.ok) {
      console.error("Groq API virhe:", data);
